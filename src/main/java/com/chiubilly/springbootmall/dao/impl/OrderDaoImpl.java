...
import com.chiubilly.springbootmall.rowmapper.OrderItemRowMapper;
import com.chiubilly.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrderItem> getOrderItemsByOrderId(Integer orderId) {
        String sql = "SELECT oi.order_item_id , oi.order_id, oi.quantity, oi.product_id, oi.amount, p.product_name, p.image_url  " +
...
//        }
        ...
        System.out.println(parameterSources.length);
